    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <section class="events container col-md-9 my-4">
            <h1 class="text-center">Adicionar ao Grupo</h1>
            

            <div class="col-12 text-right mb-3">
                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addEvento">+ Add Participante</button>
            </div>
            <table class="table col-md-10 mx-0">
                ...
                <?php $grupo->getGrupo($id); ?>
            </table>

            


            <!-- Modal Add Participate -->
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="staticBackdropLabel">Adicionar Participante</h5>
